      ...
      <div class="grid lg:grid-cols-3 gap-8 xl:gap-12">
        <div class="lg:col-span-2">
          <div v-if="step === 1" class="space-y-6">
            <div
              class="p-6 bg-white rounded-4xl border border-border/40 shadow-sm"
            >
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="space-y-1.5 col-span-2 sm:col-span-1">
                  ...
                  <input
                    ...
                    class="w-full h-11 px-4 rounded-xl border border-border bg-white text-sm focus:outline-none focus:border-primary transition-all"
                    placeholder="Ali"
                  />
                </div>
                <div class="space-y-1.5 col-span-2 sm:col-span-1">
          ...
          <div v-else-if="step === 2" class="space-y-6">
            ...
            >
              ...
              <div class="space-y-3.5">
                ...
                >
                  ...
                  <div>
                    <p
                      class="font-extrabold text-sm text-foreground leading-none"
                    >
                      {{ method.label }}
                    </p>
              ...
              <div
                ...
                class="mt-6 p-5 bg-muted/15 border border-border/50 rounded-2xl space-y-4 animate-in fade-in duration-200"
              >
                <p
                ...
                <div class="space-y-1.5">
                  ...
                  <input
                    ...
                    class="w-full h-10 px-3 rounded-lg border border-border/80 bg-white text-sm focus:outline-none focus:border-primary"
                  />
                </div>
                <div class="space-y-1.5">
                  <label class="text-xs font-semibold text-foreground"
                  ...
                  <div class="relative">
                    <input
                      ...
                      class="w-full h-10 pl-10 pr-3 rounded-lg border border-border/80 bg-white text-sm focus:outline-none focus:border-primary"
                    />
                    <CreditCard
                      :size="14"
              ...
              <div
                ...
                class="mt-6 p-4 bg-muted/15 border border-border/50 rounded-2xl text-xs text-muted-foreground animate-in fade-in duration-200"
              >
                <p class="font-bold text-foreground">Cash on Delivery</p>
                <p class="mt-1">
                  You will pay for your order in cash when the courier delivers
                  it to your address.
                </p>
              </div>
            </div>
            ...
            <div class="flex gap-3">
              <button
                @click="step = 1"
                class="px-6 py-3 rounded-xl border border-border text-sm font-bold text-foreground bg-white hover:bg-muted/50 transition-colors"
              >
                Back
              </button>
              <button
          ...
          <div v-else class="space-y-6">
            <div
              class="p-6 bg-white rounded-4xl border border-border/40 shadow-sm space-y-4"
            >
