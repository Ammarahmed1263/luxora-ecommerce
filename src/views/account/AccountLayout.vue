...
import { User, ShoppingBag, Heart, Star, Shield, LogOut, ChevronRight } from 'lucide-vue-next'
  ...
  <div class="min-h-screen bg-background">
    ...
    <main class="container mx-auto px-4 lg:px-8 py-10">
      <div class="flex gap-8 lg:gap-10">
        <!-- Sidebar -->
        <aside class="hidden lg:flex flex-col w-64 flex-shrink-0 gap-2">
          <!-- User card -->
          <div class="p-5 rounded-2xl border mb-2" style="border-color: oklch(0.88 0.008 85); background: oklch(0.975 0.006 85);">
            <div class="flex items-center gap-3">
              ...
              <div class="min-w-0">
                <p class="font-bold text-foreground text-sm truncate">{{ authStore.user?.firstName }} {{ authStore.user?.lastName }}</p>
