...
<template>
  <div
    class="p-5 rounded-2xl border bg-card transition-all duration-200 hover:shadow-sm"
  ...
  >
        ...
        <div>
          <div class="flex items-center gap-1.5">
            ...
            <div
              ...
              style="
                background: oklch(0.72 0.08 160 / 0.15);
    ...
    <div
      v-if="props.helpful !== undefined"
      class="flex items-center gap-2 mt-4 pt-3 border-t"
      style="border-color: oklch(0.88 0.008 85 / 0.6)"
    >
      <button
